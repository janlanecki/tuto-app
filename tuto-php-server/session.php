...
define("RETURNED_SESSIONS_MAX_COUNT", 8);
define("LOAD_MORE_SESSIONS_COUNT", 6);
...
$queryResult = pg_query($link,
    "{$withClause}
     SELECT sessions.*, users.name, users.surname, users.id AS uid
