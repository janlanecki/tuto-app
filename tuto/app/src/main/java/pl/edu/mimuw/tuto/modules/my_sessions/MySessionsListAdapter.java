...
import pl.edu.mimuw.tuto.modules.wall.SupertagsView;

public class MySessionsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    implements TagListView.OnTagLongClickedListener {
  ...
  MySessionsListAdapter(Optional<List<Session>> mValues, RecyclerView parentView) {
